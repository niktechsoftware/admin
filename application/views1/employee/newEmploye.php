	          ...
	          <div class="demo-form-wrapper">
	            <form  id="demo-inputmask" class="form form-horizontal" method="post">
	              ...
	              <div class="form-group">
	                ...
	                <div class="col-sm-4">
	                  <input id="form-control-1" class="form-control" name="image" type="file" required="required" value="<?= set_value('image'); ?>">
	                  <?= form_error('image'); ?>
	                </div>

	                <label class="col-sm-2 control-label" for="form-control-1">Signature</label>
	                <div class="col-sm-4">
	                  <input id="form-control-1" class="form-control" name="signature" type="file" required="required" value="<?= set_value('signature'); ?>">
	              ...
	              <div class="form-group">
	                ...
	                <div class="col-sm-4">
	                  <input id="form-control-1" class="form-control" name="idProof" type="file" required="required" value="<?= set_value('idProof'); ?>">
	                  <?= form_error('idProof'); ?>
	                </div>
