							...
							<div class="card">
								...
								<div class="card-body">
									<div class="timeline">
										...
										<div class="timeline-item">
											<div class="timeline-segment">
												<img class="timeline-media img-circle" width="40" height="40" src="<?= base_url(); ?>assets/img/0299419341.jpg" alt="Harry Jones">
											</div>
										...
										<div class="timeline-item">
											<div class="timeline-segment">
												<img class="timeline-media img-circle" width="40" height="40" src="<?= base_url(); ?>assets/img/0180441436.jpg" alt="Teddy Wilson">
											</div>
											<div class="timeline-content">
												<div class="timeline-row">
										...
										<div class="timeline-item">
											<div class="timeline-segment">
												<img class="timeline-media img-circle" width="40" height="40" src="<?= base_url(); ?>assets/img/0310728269.jpg" alt="Daniel Taylor">
											</div>
											<div class="timeline-content">
												<div class="timeline-row">
