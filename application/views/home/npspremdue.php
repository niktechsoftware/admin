              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="card-body" data-toggle="match-height">
                     <center> <h4 class="text-primary">NPS Premium Due</h4></center>
                     <div class=" panel-scroll table-responsive">
                     
                    <table class="table table-striped table-hover center" id="npsmy">
                      <?php 
                        $this->db->where('status','pending');
                        $data=$this->db->get('npsdetail')->result();
                        ?>
                      <thead>
          ...
          <div class="row gutter-xs">
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="card-body" data-toggle="match-height">
                     <center> <h4 class="text-primary">NPS Premium Due hello</h4></center>
                     <div class=" panel-scroll table-responsive">
