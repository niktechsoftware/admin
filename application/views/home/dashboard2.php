...
$this->db->where("branchID",$this->session->userdata("branchid"));
$this->db->where('transactionType','debit');
$this->db->where('updated =',$cmdate);
$cbc=$this->db->get()->row()->amount;


?>
<center><p style="font-size: 15px;"> <?php if($cbc==0){echo "0.00";}else{echo $cbc ;}?> </p></center>
...
$cbecbb=$this->db->get()->row()->amount;


?>
<center><p style="font-size: 15px;"> <?php if($cbecbb==0){echo "0.00";} else{ echo $cbecbb;}?> </p></center>
